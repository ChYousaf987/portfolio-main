...
export default function PortfolioNew() {
  ...
  return (
    <div className="relative bg-[#0D1224] text-white py-16 px-4 md:px-8 min-h-screen">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {allData.map((work, index) => (
            ...
            >
              <div className="absolute inset-0 bg-black/70 p-4 text-white flex flex-col justify-between">
                <div>
